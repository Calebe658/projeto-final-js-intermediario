...
if (pessoa) {
  ...
  document.getElementById("escolaridade").value =
    pessoa.grauEscolaridade.toLocaleLowerCase();
  ...
  document.getElementById("dataInicio").value =
    pessoa.historico[pessoa.historico.length - 1].dataInicio;
  document.getElementById("cargo").value =
    pessoa.historico[pessoa.historico.length - 1].cargo;
...
// Ao clicar o botão
document
  .getElementById("botaoAtualizarCadastro")
  .addEventListener("click", function (event) {
    ...
    if (pessoaAtualizada) {
      ...
      const historico =
        pessoaAtualizada.historico[pessoaAtualizada.historico.length - 1];
      ...
      const sexo = document.getElementById("Masculino").checked
        ? "Masculino"
        : "Feminino";
      ...
      const valeTransporte =
        document.getElementById("valeTransporte-sim").checked;
